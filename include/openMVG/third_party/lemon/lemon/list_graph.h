...
namespace lemon {
  ...
  public:
    ...
    int maxNodeId() const { return int(nodes.size()) - 1; }
    int maxArcId() const { return int(arcs.size())-1; }
    ...
    protected:
      ...
      protected:
        ...
        virtual void add(const std::vector<Arc>& arcs) {
          for (size_t i = arcs.size() - 1; i >= 0; --i) {
  ...
  public:
	...
	int maxNodeId() const { return static_cast<int>( nodes.size() - 1); }
	int maxEdgeId() const { return static_cast<int>( arcs.size() / 2 - 1); }
    int maxArcId() const { return static_cast<int>(arcs.size() - 1); }
  ...
  public:
    ...
    int maxEdgeId() const { return int(arcs.size() / 2) - 1; }
    int maxArcId() const { return int(arcs.size()) - 1; }
